  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative rounded-lg bg-slate-300 text-slate-900 dark:bg-slate-900 dark:text-white p-6 md:col-span-">
        ...
        <div className="relative rounded-lg bg-slate-300 text-slate-900 dark:bg-slate-900 dark:text-white p-6 flex flex-col justify-center md:col-span-1">
