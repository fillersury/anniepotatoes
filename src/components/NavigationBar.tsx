    ...
    <nav className="bg-slate-200 dark:bg-slate-950 shadow sticky top-0 z-50">
      ...
      >
        <div className="mt-16 flex flex-col space-y-2 px-6 font-mono uppercase tracking-wide text-lg">
          ...
          <Link to="/software" className={linkClass("/software")} onClick={() => setMobileMenuOpen(false)}>Software</Link>
          <Link to="/projects" className={linkClass("/projects")} onClick={() => setMobileMenuOpen(false)}>Projects</Link>
          <Link to="/portfolio" className={linkClass("/portfolio")} onClick={() => setMobileMenuOpen(false)}>Portfolio</Link>
